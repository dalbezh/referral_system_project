    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('referral_code', models.CharField(blank=True, max_length=6, verbose_name='referral_code')),
                ('is_verified_code', models.BooleanField(default=False, verbose_name='verified')),
